...
# 🔥 GET DATABASE URL
db_url = os.getenv("mysql://root:YwTsXLMCFtyuPYbqkqwWUyQroeyHYuMo@hopper.proxy.rlwy.net:37730/railway")
 
# 👉 fallback for local testing (IMPORTANT)
if not db_url:
    db_url = "mysql://root:YwTsXLMCFtyuPYbqkqwWUyQroeyHYuMo@hopper.proxy.rlwy.net:37730/railway"
